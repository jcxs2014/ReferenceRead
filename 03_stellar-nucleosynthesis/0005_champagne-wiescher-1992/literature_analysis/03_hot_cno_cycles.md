...
深入讨论涉及**稳定靶**的四反应（$^{12}{\rm C}$(p,$\gamma$)$^{13}{\rm N}$, $^{14}{\rm N}$(p,$\gamma$)$^{15}{\rm O}$, $^{15}{\rm N}$(p,$\alpha$)$^{12}{\rm C}$, $^{16}{\rm O}$(p,$\gamma$)$^{17}{\rm F}$），以及 HCNO 中**最关键且唯一被精确测定**的反应 $^{13}{\rm N}$(p,$\gamma$)$^{14}{\rm O}$。
...
### 3.2.3 $^{15}{\rm N}$(p,$\alpha$)$^{12}{\rm C}$

**[FACT]**

- 推荐率 (34) 基于两组数据 (38, 39) 的平均值；**低温准确**。
- 对 $T_{9}$ ≳ 1，涉及两个**假设共振** Ep = 710 和 1050 keV 的不确定贡献：
  - 710 keV 态自旋宇称 J^$\pi$ = $0^{-}$ → 至 $^{12}{\rm C}$ 基态或第一激发态的 $\alpha$ 发射**宇称禁戒**，不应作为 (p,$\alpha$) 共振考虑。
  - 1050 keV 态太弱，无天体物理意义。
- **[FACT]** 结论：**应采用 $^{15}{\rm N}$(p,$\alpha$)$^{12}{\rm C}$ 的"下限"** 用于爆炸性氢燃烧网络计算。

### 3.2.4 $^{14}{\rm N}$(p,$\gamma$)$^{15}{\rm O}$ 与 $^{16}{\rm O}$(p,$\gamma$)$^{17}{\rm F}$

**[FACT]** 未特别展开；由推荐率 (34) 直接采用。这两反应均为 CNO/HCNO 循环中**速率限制步骤的关键环节**（$^{14}{\rm N}$(p,$\gamma$)$^{15}{\rm O}$ 是 CNO I 主循环的"瓶颈"，但因其稳定靶易测，速率准确）。

## 3.3 章节 3.2: The $^{13}{\rm N}$(p,$\gamma$)$^{14}{\rm O}$ Reaction

### 3.3.1 共振基本参数

**[FACT]** 反应由 **$^{14}{\rm O}$ 中单一 J^$\pi$ = $1^{-}$ 共振的 s 波俘获**主导：
...
| + 核芯激发 [$^{13}{\rm N}$(3.51)] | Funck & Langanke (44) | 53 keV | 1.6 eV |
...
| 参数 | 值 |
|------|---|
| $^{13}{\rm N}$(p,$\gamma$)$^{14}{\rm O}$ 主导共振 E_cm | 541 ± 2 keV |
| 对应激发能 Ex | 5.17 MeV |
| 共振 J^$\pi$ | $1^{-}$ ($^{14}{\rm O}$) |
...
- (35) Rolfs & Azuma 1974
- (36–37) Kiss et al. 1989, Poyarkov & Sizov 1987 — $^{12}{\rm C}$(p,$\gamma$)$^{13}{\rm N}$ 共振位置
...
- (52) Motobayashi et al. 1991 PLB — $^{14}{\rm O}$ 库仑裂变
