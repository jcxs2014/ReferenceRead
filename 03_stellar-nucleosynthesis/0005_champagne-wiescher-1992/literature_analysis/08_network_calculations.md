...
| 编号 | $T_{9}$ | $\rho$ (g/cm³) | 时标 t | 对应天体物理事件 |
|------|-----|-----------|--------|-----------------|
...
- 初始 $^{20}{\rm Ne}$ 主要加工为 **$^{22}{\rm Mg}$**，因长半衰期（$T_{1}$/₂ = **3.86 s**）**被禁闭**。
- 已有 $^{24}{\rm Mg}$ 和 $^{28}{\rm Si}$ 加工为 **$^{26}{\rm Si}$ ($T_{1}$/₂ = 2.23 s)** 和 **$^{30}{\rm S}$ ($T_{1}$/₂ = 1.18 s)**。
...
- **$^{20}{\rm Ne}$** 在过程第 1 秒内耗尽 → 转换为 **$^{22}{\rm Mg}$**（$T_{1}$/₂ = 3.86 s）。
- 因 $^{22}{\rm Mg}$ 可被 (p,$\gamma$) 破坏，**有效半衰期更短，$T_{1}$/₂,eff = 2.4 s**。
...
- 因 **$^{52}{\rm Fe}$ 长 $\beta$ 衰变半衰期 ($T_{1}$/₂ = 8.28 h)** 与弱 $^{52}{\rm Fe}$(p,$\gamma$)$^{53}{\rm Co}$ 衰变率 → **$^{52}{\rm Fe}$ 是该条件下 rp-process 的端点**。
...
**[FACT]** ⁵⁵,$^{56}{\rm Ni}$ 上的 (p,$\gamma$) 反应 Q 值低（Q = **0.459 和 0.767 MeV**）→ **被光裂抑制** (120)。

**[FACT]** 反应继续至 **$^{64}{\rm Ge}$ ($T_{1}$/₂ = 63.7 s)**——在爆发期间**本质稳定**。
...
**[FACT]** 近期测量表明 **$^{73}{\rm Rb}$ 粒子未束缚** (110) → **rp-process 终止于 $^{72}{\rm Kr}$ ($T_{1}$/₂ = 17.2 s)**。
...
| (9) | Ẏ_i = $\Sigma$ $\lambda$_{ji}¹ + $\Sigma$ $\lambda$_{jk→i}² Y_k | 同位素丰度演化 |
