...
> "In Cameron (1963) the volatile elements are normalized to silicon = 10⁶ in the sun, which is somewhat poorly determined."
...
[FACT] Table 1 标题: "COMPILATIONS OF ABUNDANCES **NORMALIZED TO Si = 10⁶**"

### 主要元素 (H 到 Fe, 三列对照)

| Z | Element | Suess-Urey (1956) | Cameron (1963) | Cameron (1967) | Note |
|---|---------|-------------------|----------------|----------------|------|
| 1 | **H** | 4.00 × 10¹⁰ | 3.2 × 10¹⁰ | **2.6 × 10¹⁰** | 1 |
| 2 | **He** | 3.08 × 10⁹ | 5.0 × 10⁹ | **2.1 × 10⁹** | 2 |
| 3 | Li | 100 | 38 | **45** | 3 |
| 4 | Be | 20 | 7 | **0.69** | 3 |
| 5 | B | 24 | 6 | **6.2** | 3 |
| 6 | **C** | 3.5 × 10⁶ | 1.66 × 10⁷ | **1.35 × 10⁷** | 1 |
| 7 | **N** | 6.6 × 10⁶ | 3.0 × 10⁶ | **2.44 × 10⁶** | 1 |
| 8 | **O** | 2.15 × 10⁷ | 2.9 × 10⁷ | **2.36 × 10⁷** | 1 |
| 9 | F | 1600 | — | **3630** | 4 |
| 10 | **Ne** | 8.6 × 10⁶ | 1.7 × 10⁷ | **2.36 × 10⁶** | 2 |
| 11 | Na | 4.38 × 10⁴ | 4.18 × 10⁴ | **6.32 × 10⁴** | 4 |
| 12 | **Mg** | 9.12 × 10⁵ | 1.046 × 10⁶ | **1.050 × 10⁶** | 5 |
| 13 | Al | 9.48 × 10⁴ | 8.93 × 10⁴ | **8.51 × 10⁴** | 5 |
| 14 | **Si** | 1.00 × 10⁶ | 1.00 × 10⁶ | **1.00 × 10⁶** | 5 |
| 15 | P | 1.00 × 10⁴ | 9320 | **1.27 × 10⁴** | 5 |
| 16 | **S** | 3.75 × 10⁵ | 6.0 × 10⁵ | **5.06 × 10⁵** | 4 |
| 17 | Cl | 8850 | 1836 | **1970** | 4 |
| 18 | Ar | 1.4 × 10⁵ | 2.4 × 10⁵ | **2.28 × 10⁵** | 6 |
| 19 | K | 3160 | 2970 | **3240** | 4 |
| 20 | **Ca** | 4.90 × 10⁴ | 7.28 × 10⁴ | **7.36 × 10⁴** | 5 |
| 21 | Sc | 28 | 29 | **33** | 4 |
| 22 | Ti | 2240 | 3140 | **2300** | 5 |
| 23 | V | 220 | 590 | **900** | 5 |
| 24 | Cr | 7800 | 1.20 × 10⁴ | **1.24 × 10⁴** | 4 |
| 25 | Mn | 6850 | 6320 | **8800** | 4 |
| 26 | **Fe** | 6.00 × 10⁵ | 8.42 × 10⁵ | **8.90 × 10⁵** | 4 |
| 27 | Co | 1800 | 2290 | **2300** | 4 |
| 28 | **Ni** | 2.74 × 10⁴ | 4.44 × 10⁴ | **4.57 × 10⁴** | 5 |
...
1. **H, Ne 显著下降**:从 Suess-Urey 到 Cameron 1967,H 从 4×10¹⁰ → 2.6×10¹⁰ (降 35%),Ne 从 8.6×10⁶ → 2.36×10⁶ (降 73%) — 因为 Cameron 放弃了 Suess-Urey 的高 H 天文估计,改用太阳大气归一化 [FACT]
2. **He 剧烈下降**:从 5.0×10⁹ (1963) → 2.1×10⁹ (1967) — He/Ne 归一化从"以 Sun Si = 10⁶"改为"太阳宇宙线 + 太阳 O"[FACT]
...
[FACT] Table 2 给出 92 种元素的各核素丰度,含 5 列: **Element / A (质量数) / % Abundance (同位素丰度) / Class / Abundance (数密度, Si = 10⁶)**。

### Class 分类约定 [FACT]

| Class | 含义 | 对应过程 |
|-------|------|---------|
| **F** (fast) | 快速时间尺度中子俘获主产物 | r-process (B²FH 1957) |
| **S** (slow) | 慢速时间尺度中子俘获主产物 | s-process (B²FH 1957) |
| **B** (bypassed) | 被中子俘获过程绕过的核素 | p-process (B²FH 1957) |

### 主要核素丰度 (Cameron 1967)

| Element | A | % Abundance | Class | Abundance (Si=10⁶) |
|---------|---|-------------|-------|--------------------|
| H | 1 | 99.985 | — | 2.6 × 10¹⁰ |
| H | 2 | 0.015 | — | 2.6 × 10¹⁰ (注: D/H ≈ 10⁻⁴ 数量级,OCR 可能混淆, 见 [FACT] 原文) |
| He | 3 | ~0.03 | — | 3.9 × 10⁶ |
| He | 4 | ~100 | — | 2.1 × 10⁹ |
| Li | 6 | 7.42 | — | 4.50 |
| Li | 7 | 92.58 | — | 5.00 |
...
| Pb-206 | 206 | — | 0.057 | α-衰变链(已作放射性回推) |
| U-238 | 238 | — | 0.0234 | 已回推 4.5×10⁹ 年 |

[FACT] **放射性回推**(§5 末):

> "The abundances of **uranium, thorium, and K⁴⁰** isotopes have been corrected for a decay interval of **4.5 × 10⁹ years** to make them typical of the **initial solar system**; other radioactive nuclides have not been corrected because the half-lives are long and the corrections small."
...
[FACT] Fig 6 三曲线:
- S 同量异位素趋势: 相对光滑但局部有散布 —— 因为 σ_N = ⟨σ_ν⟩ × N 是光滑单调递减函数 (Seeger, Fowler, Clayton 1965)
...
3. **理论约束内插**: 8 元素内插基于 r/s/p 三分法预言的核素分布规律,这是**"以理论导数据"**的首次系统实践——B²FH 理论反过来塑造了观测表。
...
[INTERPRETATION] Cameron 1968 表是"丰度—核合成"双反馈范式的关键节点: 它既给 B²FH 提供了定量基准(用于检验理论),又被 B²FH 的理论判据所塑造(8 元素内插)。这个互锁结构是 1950–1970 年代核天体物理的核心方法论特征。
