...
|---|---------|-------------------|----------------|----------------|------|
| 1 | **H** | 4.00 × $10^{10}$ | 3.2 × $10^{10}$ | **2.6 × $10^{10}$** | 1 |
| 2 | **He** | 3.08 × $10^{9}$ | 5.0 × $10^{9}$ | **2.1 × $10^{9}$** | 2 |
| 3 | Li | 100 | 38 | **45** | 3 |
| 4 | Be | 20 | 7 | **0.69** | 3 |
| 5 | B | 24 | 6 | **6.2** | 3 |
| 6 | **C** | 3.5 × $10^{6}$ | 1.66 × $10^{7}$ | **1.35 × $10^{7}$** | 1 |
| 7 | **N** | 6.6 × $10^{6}$ | 3.0 × $10^{6}$ | **2.44 × $10^{6}$** | 1 |
| 8 | **O** | 2.15 × $10^{7}$ | 2.9 × $10^{7}$ | **2.36 × $10^{7}$** | 1 |
| 9 | F | 1600 | — | **3630** | 4 |
| 10 | **Ne** | 8.6 × $10^{6}$ | 1.7 × $10^{7}$ | **2.36 × $10^{6}$** | 2 |
| 11 | Na | 4.38 × $10^{4}$ | 4.18 × $10^{4}$ | **6.32 × $10^{4}$** | 4 |
| 12 | **Mg** | 9.12 × $10^{5}$ | 1.046 × $10^{6}$ | **1.050 × $10^{6}$** | 5 |
| 13 | Al | 9.48 × $10^{4}$ | 8.93 × $10^{4}$ | **8.51 × $10^{4}$** | 5 |
| 14 | **Si** | 1.00 × $10^{6}$ | 1.00 × $10^{6}$ | **1.00 × $10^{6}$** | 5 |
| 15 | P | 1.00 × $10^{4}$ | 9320 | **1.27 × $10^{4}$** | 5 |
| 16 | **S** | 3.75 × $10^{5}$ | 6.0 × $10^{5}$ | **5.06 × $10^{5}$** | 4 |
| 17 | Cl | 8850 | 1836 | **1970** | 4 |
| 18 | Ar | 1.4 × $10^{5}$ | 2.4 × $10^{5}$ | **2.28 × $10^{5}$** | 6 |
| 19 | K | 3160 | 2970 | **3240** | 4 |
| 20 | **Ca** | 4.90 × $10^{4}$ | 7.28 × $10^{4}$ | **7.36 × $10^{4}$** | 5 |
| 21 | Sc | 28 | 29 | **33** | 4 |
| 22 | Ti | 2240 | 3140 | **2300** | 5 |
| 23 | V | 220 | 590 | **900** | 5 |
| 24 | Cr | 7800 | 1.20 × $10^{4}$ | **1.24 × $10^{4}$** | 4 |
| 25 | Mn | 6850 | 6320 | **8800** | 4 |
| 26 | **Fe** | 6.00 × $10^{5}$ | 8.42 × $10^{5}$ | **8.90 × $10^{5}$** | 4 |
| 27 | Co | 1800 | 2290 | **2300** | 4 |
| 28 | **Ni** | 2.74 × $10^{4}$ | 4.44 × $10^{4}$ | **4.57 × $10^{4}$** | 5 |
...
1. **H, Ne 显著下降**:从 Suess-Urey 到 Cameron 1967,H 从 4×$10^{10}$ → 2.6×$10^{10}$ (降 35%),Ne 从 8.6×$10^{6}$ → 2.36×$10^{6}$ (降 73%) — 因为 Cameron 放弃了 Suess-Urey 的高 H 天文估计,改用太阳大气归一化 [FACT]
2. **He 剧烈下降**:从 5.0×$10^{9}$ (1963) → 2.1×$10^{9}$ (1967) — He/Ne 归一化从"以 Sun Si = $10^{6}$"改为"太阳宇宙线 + 太阳 O"[FACT]
...
|---------|---|-------------|-------|--------------------|
| H | 1 | 99.985 | — | 2.6 × $10^{10}$ |
| H | 2 | 0.015 | — | 2.6 × $10^{10}$ (注: D/H ≈ $10^{-4}$ 数量级,OCR 可能混淆, 见 [FACT] 原文) |
| He | 3 | ~0.03 | — | 3.9 × $10^{6}$ |
| He | 4 | ~100 | — | 2.1 × $10^{9}$ |
| Li | 6 | 7.42 | — | 4.50 |
| Li | 7 | 92.58 | — | 5.00 |
...
| B | 10 | 19.64 | — | 1.33 |
| B | 11 | 80.36 | — | 5.00 |
| C | 12 | 98.89 | — | 1.33 × $10^{7}$ |
| C | 13 | 1.11 | — | 1.50 × $10^{5}$ |
| N | 14 | 99.634 | — | 2.43 × $10^{6}$ |
| N | 15 | 0.366 | — | 8980 |
| O | 16 | 99.759 | — | 2.354 × $10^{7}$ |
| O | 17 | 0.0374 | — | 8830 |
| O | 18 | 0.2039 | — | 48100 |
| F | 19 | 100 | — | 3630 |
| Ne | 20 | 90.92 | — | 2.14 × $10^{6}$ |
| Ne | 21 | 0.257 | — | 6060 |
| Ne | 22 | 8.82 | — | 2.08 × $10^{5}$ |
| Na | 23 | 100 | — | 6.32 × $10^{4}$ |
| Mg | 24 | 78.70 | — | 8.26 × $10^{5}$ |
| Mg | 25 | 10.13 | — | 1.06 × $10^{5}$ |
| Mg | 26 | 11.17 | — | 1.17 × $10^{5}$ |
| Al | 27 | 100 | — | 8.51 × $10^{4}$ |
| Si | 28 | 92.21 | — | 9.22 × $10^{5}$ |
| Si | 29 | 4.70 | — | 4.70 × $10^{4}$ |
| Si | 30 | 3.09 | — | 3.09 × $10^{4}$ |
| Fe | 54 | 5.82 | — | 51800 |
| Fe | 56 | 91.66 | — | 8.15 × $10^{5}$ |
| Fe | 57 | 2.19 | — | 1.95 × $10^{4}$ |
| Fe | 58 | 0.33 | — | 2940 |
| Ni | 58 | 67.88 | — | 3.10 × $10^{4}$ |
| Ni | 60 | 26.23 | — | 1.20 × $10^{4}$ |
| Ni | 62 | 3.66 | — | 1670 |
| Ni | 64 | 2.19 | — | 1000 |
| ... | ... | ... | ... | ... |
| Sr | 84 | 50.537 | S | 2.12 |
...
| U-238 | 238 | — | 0.0234 | 已回推 4.5×$10^{9}$ 年 |

[FACT] **放射性回推**(§5 末):

> "The abundances of **uranium, thorium, and K⁴⁰** isotopes have been corrected for a decay interval of **4.5 × $10^{9}$ years** to make them typical of the **initial solar system**; other radioactive nuclides have not been corrected because the half-lives are long and the corrections small."
...
[FACT] Fig 6 三曲线:
- S 同量异位素趋势: 相对光滑但局部有散布 —— 因为 $\sigma$_N = ⟨$\sigma$_$\nu$⟩ × N 是光滑单调递减函数 (Seeger, Fowler, Clayton 1965)
