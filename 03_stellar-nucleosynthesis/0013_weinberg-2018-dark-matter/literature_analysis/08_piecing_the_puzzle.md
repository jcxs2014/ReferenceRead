...
>
> 上一章：`07_dark_matter_particles.md`
>
> 下一章：`09_hunt_for_dm.md`
...
- [FACT] 星系团观测暗示 Ω_m 远不足以闭合宇宙（White et al. 1993）。
...
- [CRITIQUE] 2018 年时暗能量 + CDM 的 ΛCDM 范式已成标准宇宙学模型；作者未花篇幅讨论 ΛCDM 自身的理论困难（如**巧合问题**、**宇宙学常数问题**）。
