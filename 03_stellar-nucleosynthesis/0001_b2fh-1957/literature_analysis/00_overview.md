...
| **Title** | *Synthesis of the Elements in Stars* |
| **Authors** | K. MARGARET BURBIDGE; G. R. BURBIDGE; WILLIAM A. FOWLER; F. HOYLE |
| **Affiliations** | Keck (原文拼为 Eellogg) Radiation Laboratory, California Institute of Technology；Mount Wilson & Palomar Observatories, Carnegie Institution of Washington |
| **Journal** | *Reviews of Modern Physics*, Vol. 29, No. 4 |
| **Publication Date** | October 1957 |
| **Pages** | 547–647（108 页；正文 108 页含附录/参考文献） |
| **DOI** | 10.1103/RevModPhys.29.547（本 PDF 未直接给出 DOI，由引文推断） |
| **arXiv** | 未提供（1957 年出版，早于 arXiv） |
...
**题记引文（作者开篇即立基调）**：[FACT]
- 莎士比亚《李尔王》第四幕第三场："It is the stars, the stars above us, govern our conditions."
- 莎士比亚《裘力斯·凯撒》第一幕第二场："The fault, dear Brutus, is not in our stars, but in ourselves."
...
[FACT]
1. 宇宙丰度曲线的精细结构（Goldschmidt/Brown/Suess & Urey 曲线）的物理起源是什么？
2. 元素起源：是宇宙诞生初期的"原始合成"（Gamow/Alpher/Herman 非平衡、Mayer/Teller 多中子、Klein/Beskow/Treffenberg 平衡），还是在恒星内部持续进行？
3. 如何用一套自洽的核物理模型把每个稳定（及天然放射性）同位素指派到一个具体的合成过程？

## 0.4 论文结构树（原文章节）

```
I.   Introduction (P1–P5)
...
II.  Physical Processes Involved in Stellar Synthesis, Their Place of Occurrence, and the Time-Scales Associated with Them (P5–P13)
    A. Modes of Element Synthesis  (八大过程 i–viii)
...
VII. Details of the r Process (P48–P59)
    ...
    C. Time for the r Process: Steady Flow and Cycling
    D. Freezing of the r-Process Abundances
...
X.   X Processes — Deuterium, Lithium, Beryllium, Boron (P74–P75)
    ...
    C. Synthesis Possibilities（宇宙线散裂、恒星大气等）
...
XIII. Conclusion (P95)
    —
    Acknowledgments (P95)
    Appendix（同位素一览表，P96–P102）
    Bibliography (P102–P104)
```

## 0.5 八大合成过程一览（论文核心术语表）[FACT]
...
| 编号 | 主题 |
|---|---|
| Fig. I.1 | 元素丰度曲线示意（Suess & Urey） |
| Fig. I.2 | 恒星核合成过程示意图（主图） |
| Fig. II.1 | 同位素丰度 vs A 的对数图，s/r/p 分色 |
| Fig. II.2 | 奇 A 丰度峰（A=129/139 附近），N=82 |
| Fig. II.3 | 偶 A 丰度峰（A=130/138 附近），N=50,Z=50 |
...
| Fig. VIII.2 | r 过程放射性能量释放 vs 时间 |
| Fig. VIII.3 | 超新星放射性能量释放 |
| Fig. IX.1 | p 过程核丰度 |
| Fig. IX.2 | p 过程在 (Z,A) 平面的路径 |
| Fig. XI.1 | S 型星 s 过程谱线 |
| Fig. XI.2 | Peculiar A 星丰度反常 |
| Fig. XII.1 | 银河系元素增丰示意 |
| Fig. XII.2 | 历史超新星遗迹位置图 |
...
本报告所有文件严格区分三类信息：
- **[FACT]** — 论文原文陈述的事实、数据、公式、结论
- **[INTERPRETATION]** — 基于论文内容的合理解释（非作者原话）
