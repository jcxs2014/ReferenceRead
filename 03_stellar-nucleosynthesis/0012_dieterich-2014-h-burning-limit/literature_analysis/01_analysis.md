...
[FACT] 关键公式：
> **L = 4$\pi$R² $\sigma$_SB T_eff⁴**
> $\sigma$_SB = 5.6704 × $10^{-5}$ erg cm⁻² s⁻¹ K⁻⁴
...
1. **Stefan–Boltzmann（半径）**：L = 4$\pi$R² $\sigma$_SB T_eff⁴，$\sigma$_SB = 5.6704 × $10^{-5}$ erg cm⁻² s⁻¹ K⁻⁴
2. **等效温度定义**：F = $\sigma$_SB T⁴（黑体通量等同）
