...
> **[FACT]** **β-decay 测量**：RIKEN 等已系统测量 $T_{1/2,\beta}$ 和 $P_n$（β-delayed neutron probability）。
...
截至 2021 年，r 过程路径上 ~50-80% 核素的输入数据（mass, β-decay, n-capture rate）依赖理论外推。FRIB 等新一代设施的核心目标就是填补这一缺口。
...
- **β-decay**：相对简单
- **neutron capture**：极其困难——需放射性样品 + 单色中子源 + 微弱 γ 探测
...
2. 理论 mass 模型基准未深入
3. mass 缺失的代价未量化
4. 实验室 vs stellar β-decay rates 差异未讨论
