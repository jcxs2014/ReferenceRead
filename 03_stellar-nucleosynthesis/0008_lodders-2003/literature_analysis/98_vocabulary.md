...
| oxygen fugacity $fO_{2}$ | 氧逸度 | 气体中氧的化学势相关量；控制氧化物冷凝顺序 | §3.1 |
...
| X, Y, Z | 氢、氦、金属质量分数 | 本文 X=0.7491、Y=0.2377、Z=0.0133（大气）；$X_{0}$=0.7110、$Y_{0}$=0.2741、$Z_{0}$=0.0149（太阳系） | §2 |
| Z/X | 金属对氢质量比 | 太阳大气 Z/X=0.0177；原太阳 $Z_{0}$/$X_{0}$=0.0210 | §2.5.2 |
...
| perovskite $CaTiO_{3}$ | 钙钛矿 | 主量元素 Ca、Ti 的重要凝聚相；也是 REE、Sr、Ba 等的宿主 | §3.2 |
| forsterite $Mg_{2}$$SiO_{4}$ | 镁橄榄石 | Mg、Si 大规模从气相移出的起点，冷凝温度 1354 K | §3.2 |
| enstatite $MgSiO_{3}$ | 镁灰石 | 与镁橄榄石共同移除 Mg、Si | §3.2 |
...
| SSM (Standard Solar Model) | 标准太阳模型 | Boothroyd & Sackmann (2003) 拟合关系，从 Z/X 推导 Y、$Z_{0}$、$X_{0}$ | §2.3.1.1 |
...
| ices: $H_{2}$O, $CH_{4}$·7$H_{2}$O, $NH_{3}$·$H_{2}$O, $N_{2}$·7$H_{2}$O | 冰：水冰、甲烷水合物、氨水合物、氮水合物 | 高挥发元素冷凝产物，冷凝温度受动力学效应强烈影响 | §3.4 |
...
### C4. §3.1（CONDOR 方法）
> "**CONDOR** treats **2000 gas-phase species** and **1600 condensates** of **all 83 natural elements** simultaneously, **converging** each element's computed abundance to its input value to **1 part in $10^{15}$**; **this is essential** because trace-element chemistry is strongly influenced by the chemistry of the major-element host phases."
...
**翻译**：CONDOR 同时处理 2000 种气相物种和 1600 种凝聚相的 83 种天然元素，将每个元素计算出的丰度与输入值收敛到 $10^{-15}$ 的精度；这一点至关重要，因为微量元素的化学强烈受主量元素宿主相化学的影响。
