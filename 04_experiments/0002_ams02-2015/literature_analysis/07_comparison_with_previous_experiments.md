...
[FACT] AMS-02 观测时间：30 个月（2011 年 5 月至 2013 年 5 月），对应 $4.1\times10^{10}$ 总宇宙线事件中筛选出的 300 M 质子事件（原文 p.3，Table 1）

[FACT] ATIC-2 能量范围：~50 GeV – ~TeV，单次南极气球飞行（2000 年前后），系统误差 ~10%–20%（原文脚注 [3]，p.6）

[FACT] BESS-Polar II 观测时间：2007 年 12 月至 2008 年 1 月，25 天南极气球飞行，统计+系统误差合并约 ~5%–10%（原文脚注 [4]，p.6）

[FACT] CREAM 观测次数：3 次南极气球实验累计（2001–2006 年），系统误差 ~10%–30%（原文脚注 [5]，p.6）

[FACT] PAMELA 能量范围：~2 GeV – ~200 GeV（动能），轨道平台，~3%–5% 系统误差，多年观测（原文脚注 [6]，p.6）

[FACT] AMS-02 在 <100 GeV 与 PAMELA 数据在误差范围内几乎重合（PAMELA 轨道精度接近 AMS-02，但覆盖范围仅至 200 GeV）（原文 p.6，Fig.3(b)）

[FACT] CREAM 在 >100 GeV 系统误差条显著大于 AMS-02（CREAM 10–30% vs AMS-02 <5%），因此 AMS-02 的 TeV 端测量填补了精度空白（原文 p.6，Fig.3(b)）
