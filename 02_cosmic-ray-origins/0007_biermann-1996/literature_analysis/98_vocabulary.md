...
| 尤其 | 尤其 | in particular / notably | adv. | "- **[FACT]** 穿越热物质一段时间 $\tau$ 后，出现低能截止，分布为： - 截止以下：~$\beta^{2}$ d$\beta$ （式 3） - 截止以上：原律 - 截止速度：$\beta_{\rm crit}$ ∼ {Z$^{2}$ (n_e, n_H) $\tau$}^(1/3) （式 4） - **[FACT]** 低于截止的粒子相空间上转移到热粒子库，可改变热粒子化学丰度——对 Li、Be、B 等丰度差异大的元素**尤其重要**。 - **[FACT]** **grammage**（" | 举例 |
