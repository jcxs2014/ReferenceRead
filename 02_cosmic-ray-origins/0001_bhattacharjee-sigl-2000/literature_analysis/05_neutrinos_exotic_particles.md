...
```
d$\sigma$/(d$\mu$) = (G_F² s / 4$\pi$) · M_Z² / [(s−M_Z²)² + M_Z²$\Gamma_{\rm Z2}$] · [g_L²(1+$\mu$*)² + g_R²(1−$\mu$*)²]
```
- $\mu$*：CM 散射角余弦
- g_L, g_R：左右耦合常数
...
**t-channel 截面 (公式 23)**：
```
$\sigma_{\rm t}$(E,$\epsilon$) ~ min[$10^{-34}$, $3\times10^{-39}$ · ($\epsilon$/$10^{-3}$ eV) · (E/$10^{20}$ eV)]  cm²
```
...
- **$\gamma$ + $\nu$ → $\gamma$ + $\gamma$ + $\nu$** [198]：
```
$\sigma$ ≃ $9\times10^{-56}$ (s/MeV²)⁵  cm²    valid up to s ≲ 10 MeV²
```
- 若 s⁵ 行为持续到 s ~几百 MeV²，则此过程在 E ~ $3\times10^{17}$ ($\epsilon$/$10^{-3}$ eV) eV 开始主导 [199]。
...
Super-K 结果：$\mu$-$\tau$ 近最大混合，|$\Delta$m²| ≃ $5\times10^{-3}$ eV² [212]：
```
L_osc = 2E/|$\Delta$m²| = $2.6\times10^{-6}$ (E/PeV) (|$\Delta$m²|/$5\times10^{-3}$ eV²)⁻¹ pc
```
...
**中微子-核子 CC 截面 (公式 25)**：
```
$\sigma_\nu$N(E) ≃ $2.36\times10^{-32}$ (E/$10^{19}$ eV)^0.363  cm²    ($10^{16}$ eV ≲ E ≲ $10^{21}$ eV)
```
- CTEQ4-DIS 参数化 [227]。
...
```
$\sigma_{\rm g}$ ≃ 4$\pi$s/M_{4+n}⁴ ≃ $10^{-27}$ (M_{4+n}/TeV)⁻⁴ (E/$10^{20}$ eV)  cm²   (公式 26)
```
...
**额外维度半径 (公式 27)**：
```
r_n ≃ M_{4+n}⁻¹ (M_Pl/M_{4+n})^{2/n} ≃ $2\times10^{-17}$ (TeV/M_{4+n}) (M_Pl/M_{4+n})^{2/n}  cm
```
...
| $\sigma_{\rm t}$(E,$\epsilon$) (t-channel) | min[$10^{-34}$, $3\times10^{-39}$($\epsilon$/$10^{-3}$ eV)(E/$10^{20}$ eV)] cm² |
| $\sigma_\nu$N (CC, 公式 25) | $2.36\times10^{-32}$ (E/$10^{19}$ eV)^0.363 cm² |
| Z-burst 阈值 | $4\times10^{21}$ (eV/m_$\nu$) eV |
| Super-K |$\Delta$m²| | $5\times10^{-3}$ eV² |
| ADD $\sigma_{\rm g}$ (公式 26) | $10^{-27}$ (M/TeV)⁻⁴ (E/$10^{20}$ eV) cm² |
