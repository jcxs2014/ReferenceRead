...
>
> 上一章：[[02_cosmic-ray-origins/0001_bhattacharjee-sigl-2000/literature_analysis/05_neutrinos_exotic_particles.md|05_neutrinos_exotic_particles]]
>
> 下一章：[[02_cosmic-ray-origins/0001_bhattacharjee-sigl-2000/literature_analysis/07_source_search_transport.md|07_source_search_transport]]
...
key_formulas:
  - "dE/dt = -(4/3) σ_T (B$^{2}$/8π) (q m_e/m)^4 (E/m_e)^2"
  - "E_tr ~ 10$^{20}$ (B/10$^{-10}$ G)$^{-1}$ eV"
  - "θ ≈ 0.8° q (E/10$^{20}$ eV)$^{-1}$ (d/10 Mpc)^½ (l_c/Mpc)^½ (B/10$^{-9}$ G)"
  - "τ ∝ E$^{-2}$"
  - "B l_c^½ ≲ 10$^{-9}$ G Mpc^½"
keywords:
  - synchrotron cooling
