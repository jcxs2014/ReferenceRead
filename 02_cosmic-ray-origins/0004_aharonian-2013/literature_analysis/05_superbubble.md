...
- Fermi-LAT 首次在 Cygnus 区（OB 联合体，1.4 kpc）探测到硬 γ 谱，支持超泡 CR 加速假说。
...
- [FACT] 超泡的**重元素富集**可解释 CR 中难熔元素和 ²²Ne 的超丰（Higdon & Lingenfelter 2005, 2006, 2013）。
...
| OB 星形成时间尺度 | ~few Myr |
| 星团内部爆炸范围 | ~几十 pc |
| 银河系核心坍缩 SN 在超泡内比例 | ~85% |
| Cygnus 距地 | 1.4 kpc |
| Cygnus γ 谱 | 明显硬于平均银河系 γ 谱 |
...
- **信息缺失**：超泡中 CR 的**化学组成**（是否富含难熔元素？²²Ne 比例？）未在本文展开。
