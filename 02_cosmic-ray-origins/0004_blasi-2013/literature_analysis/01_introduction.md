...
- **膝点物理解释**：各元素截止叠加（刚性依赖加速），若 p_max ≈ $5\times10^{15}$ eV，则 Fe_max ≈ 26 × $5\times10^{15}$ eV ≈ (1–2) × $10^{17}$ eV。
- **SNR 作为主源的间接证据**：$\gamma$ 射线 $\pi^{0}$ 衰变证据（MC 邻近 SNR，Tycho）、X 射线窄磁边缘、DSA 理论。
...
- [FACT] 膝点叠加假设（刚性依赖加速）：
  - 若 E_p,max ≈ $5\times10^{15}$ eV，则 Fe_max = 26 · E_p,max ≈ (1–2) × $10^{17}$ eV。
