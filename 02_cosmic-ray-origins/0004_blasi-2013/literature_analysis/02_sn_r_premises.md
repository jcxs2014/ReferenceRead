...
- 结论：ξ_CR ≈ 2.5 × $10^{-3}$ 仅计质子；含重核后 ξ_CR ≈ 5–10%，与 10% 的"10% 定律"吻合。
...
- [FACT] 地球处质子通量：J(E) = (c/4π) · N(E)·R_SN / (π R_d²·(2H)) · τ_esc(E)⁻¹ = 8×$10^{5}$·ξ_CR·I(γ) · (R_SN/30 yr⁻¹) · (E/m)⁻ᵞ⁻ᵟ · (E*/m)ᵟ m⁻²s⁻¹sr⁻¹GeV⁻¹（Eq. 2）
- [FACT] 归一化到 10 GeV 通量后得到 ξ_CR ≈ 2.5 × $10^{-3}$ · I(γ)⁻¹ · (E*/m)ᵞ⁻² · (R_SN/30 yr⁻¹)⁻¹（Eq. 3）。
...
其中 X~1 g/cm²、μ ≈ 1.4 m_p、n̄ = n_disc·h/H = 5×$10^{-2}$ · (n_disc/1 cm⁻³)·(H/3 kpc)⁻¹ cm⁻³。
