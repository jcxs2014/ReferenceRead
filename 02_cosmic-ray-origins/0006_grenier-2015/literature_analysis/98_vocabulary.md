...
| 而 | 而 | whereas / while / and | conj. | "**[FACT]** 替代方案：**外银缺失气体**（$\gamma$ 射线示踪 CR×气体积）。 - CNM 冷 HI 更容易自吸收 → 8.5 到 10 kpc 内 CNM 分数减半不足以抚平 q$\gamma_{\rm H}$ 剖面。 - >10 kpc，15–20% CNM 均匀（Dickey 2009; Pineda 2013）。 - **暗中性介质（DNM）**：HI-bright 与 CO-bright 之间的界面，大量气体在射电巡天中遗失；超出太阳圈 DNM" | 对比/转折 |
