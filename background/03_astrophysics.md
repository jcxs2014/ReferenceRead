...
A&G 1989        Z/X = 0.0267,  O = 8.86, C = 8.52, Fe = 7.50       [旧基准]
  ...
  → Lodders 2003（本文 0008）
      ...
      原始: X₀=0.7110, Y₀=0.2741, Z₀=0.0149, Z₀/X₀=0.0210
...
| 星系团 M/L | Zwicky 1937 Coma M/L ≈ 500（修正 H₀ 后仍高 ~60）| 1937 |
...
| 轴子 | PQ 机制 | 10⁻⁶ – 10⁻⁴ eV | ADMX 已覆盖 1.9–3.3 μeV |
...
4. **H₀ tension**：Planck 67.4 vs 局部 74 km/s/Mpc
